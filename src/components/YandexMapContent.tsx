  ...
  return (
    ...
    >
      ...
      {cars.map((car) => {
        ...
        const priceText = getMarkerPrice(car);
        ...
        return (
          ...
          >
            ...
            >
              <div
                className={`w-10 h-10 rounded-full shadow-lg flex items-center justify-center border-2 border-white transition-all ${
                  isSelected
              ...
              {priceText && (
                <div
                  className={`absolute left-1/2 transform -translate-x-1/2 whitespace-nowrap
                                    ...
                                    ${
                                      isSelected
                                        ? "-top-9 bg-[var(--tg-theme-bg-color)] px-2.5 py-1 border border-[var(--color-accent)]/30 text-xs font-bold"
                                        : "-top-7 bg-[var(--tg-theme-bg-color)]/90 px-1.5 py-0.5 border border-[var(--tg-theme-hint-color)]/20 text-[10px] font-semibold"
                                    }
                                `}
                >
                  <span
