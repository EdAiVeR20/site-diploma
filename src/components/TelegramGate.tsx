  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] z-[200] p-6">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-1/3 right-1/4 w-48 h-48 bg-purple-500/10 rounded-full blur-3xl animate-pulse"
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-blue-200/60 text-sm leading-relaxed">
                Для доступа к сервису используйте наше мини-приложение в
                Telegram. Нажмите на кнопку ниже.
              </p>
            </div>
          </div>
