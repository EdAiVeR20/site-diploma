...
export function ProfilePage({ onNavigateToVerification }: ProfilePageProps) {
    ...
    const getVerificationStatusText = (status: VerificationStatus): { text: string; badgeClass: string } => {
        switch (status) {
            ...
            default:
                return { text: 'Не пройдена', badgeClass: 'text-[var(--tg-theme-hint-color)]' };
        }
    };
        ...
        <div className="flex flex-col min-h-full px-4 pt-4 pb-6">
            ...
            <div className="space-y-3 mb-6">
                ...
                {profile?.hasActiveRental && (
                    <div className="flex items-center gap-3 p-4 bg-green-500/10 border border-green-500/30 rounded-xl animate-slide-up" style={{ animationDelay: '0.2s' }}>
